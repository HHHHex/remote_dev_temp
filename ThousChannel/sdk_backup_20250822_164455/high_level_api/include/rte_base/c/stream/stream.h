...
typedef struct RtePresenceState RtePresenceState;
...
AGORA_RTE_API_C void RteStreamConfigDeinit(RteStreamConfig *config,
                                          RteError *err);
AGORA_RTE_API_C void RteStreamConfigCopy(RteStreamConfig *dest,
                                        const RteStreamConfig *src,
                                        RteError *err);
...
AGORA_RTE_API_C void RteStreamInfoCopy(RteStreamInfo *dest, const RteStreamInfo *src, RteError *err);
// @}

// @{
// stats
AGORA_RTE_API_C void RteStreamStatsInit(RteStreamStats *stats, RteError *err);
AGORA_RTE_API_C void RteStreamStatsDeinit(RteStreamStats *stats, RteError *err);
// @}

AGORA_RTE_API_C bool RteStreamGetInfo(RteStream *self, RteStreamInfo *info,
                                     RteError *err);

AGORA_RTE_API_C bool RteStreamSetConfigs(RteStream *self, RteStreamConfig *config,
                                         RteError *err);

AGORA_RTE_API_C bool RteStreamGetConfigs(RteStream *self, RteStreamConfig *config,
                                         RteError *err);

AGORA_RTE_API_C bool RteStreamRegisterObserver(
    RteStream *self, RteStreamObserver *observer, RteError *err);
    
AGORA_RTE_API_C bool RteStreamUnregisterObserver(
    RteStream *self, RteStreamObserver *observer, RteError *err);

AGORA_RTE_API_C RteAudioTrack RteStreamGetAudioTrack(RteStream *self,
                                                    RteError *err);
AGORA_RTE_API_C bool RteStreamAddAudioTrack(RteStream *self,
                                           RteAudioTrack *audio_track,
                                           RteError *err);
AGORA_RTE_API_C bool RteStreamDelAudioTrack(RteStream *self,
                                           RteAudioTrack *audio_track,
                                           RteError *err);

AGORA_RTE_API_C RteVideoTrack RteStreamGetVideoTrack(RteStream *self,
                                                    RteError *err);
AGORA_RTE_API_C bool RteStreamAddVideoTrack(RteStream *self,
                                           RteVideoTrack *video_track,
                                           RteError *err);
AGORA_RTE_API_C bool RteStreamDelVideoTrack(RteStream *self,
                                           RteVideoTrack *video_track,
                                           RteError *err);

AGORA_RTE_API_C RteDataTrack RteStreamGetDataTrack(RteStream *self,
                                                  RteError *err);
AGORA_RTE_API_C bool RteStreamAddDataTrack(RteStream *self,
                                          RteDataTrack *data_track,
                                          RteError *err);
AGORA_RTE_API_C bool RteStreamDelDataTrack(RteStream *self,
                                          RteDataTrack *data_track,
                                          RteError *err);


AGORA_RTE_API_C void RteStreamSetAudioEncoderConfig(
    RteStream *self, RteStreamConfig *config,
    void (*cb)(RteStream *stream, void *cb_data, RteError *err), void *cb_data);

AGORA_RTE_API_C void RteStreamSetVideoEncoderConfig(
    RteStream *self, RteStreamConfig *config,
    void (*cb)(RteStream *stream, void *cb_data, RteError *err), void *cb_data);


AGORA_RTE_API_C void RteStreamGetState(
    RteStream *self,
    void (*cb)(RteStream *self, RtePresenceState *state, void *cb_data, RteError *err),
    void *cb_data);

AGORA_RTE_API_C void RteStreamSetState(
    RteStream *self,
    void (*cb)(RteStream *self, void *cb_data, RteError *err),
    void *cb_data);

AGORA_RTE_API_C void RteStreamRemoveState(
    RteStream *self, const char *key,
    void (*cb)(RteStream *self, void *cb_data, RteError *err),
    void *cb_data);
