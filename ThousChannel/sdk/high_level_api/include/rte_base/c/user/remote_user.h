...
AGORA_RTE_API_C void RteRemoteUserConfigDeinit(RteRemoteUserConfig *config,
                                              RteError *err);
AGORA_RTE_API_C void RteRemoteUserConfigCopy(RteRemoteUserConfig *src,
                                            RteRemoteUserConfig *dst,
                                            RteError *err);
...
AGORA_RTE_API_C void RteRemoteUserInfoDeinit(RteRemoteUserInfo *info,
                                            RteError *err);
AGORA_RTE_API_C void RteRemoteUserInfoCopy(RteRemoteUserInfo* self,
                                          RteRemoteUserInfo* other,
                                          RteError *err);
// @}

AGORA_RTE_API_C bool RteRemoteUserGetConfigs(RteRemoteUser *self,
...
AGORA_RTE_API_C bool RteRemoteUserGetInfo(RteRemoteUser *self,
