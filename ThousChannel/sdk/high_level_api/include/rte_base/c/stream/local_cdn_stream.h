...
typedef struct RteLocalCdnStreamInfo {
  RteCdnStreamInfo cdn_stream_info;
  RteLocalStreamInfo local_stream_info;
} RteLocalCdnStreamInfo;
...
AGORA_RTE_API_C void RteLocalCdnStreamInfoInit(RteLocalCdnStreamInfo *info,
                                              RteError *err);
AGORA_RTE_API_C void RteLocalCdnStreamInfoDeinit(RteLocalCdnStreamInfo *info,
                                                RteError *err);
